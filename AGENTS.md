# Local Transcribe — Agent Instructions

Cross-tool agent guide. Any AI coding assistant (Codex, Cursor, Gemini, Claude Code, etc.)
should read this before working in the repo.
...
git add voice-type.py platform_win.py meeting_mode.py \
        ...
        list_devices.py start.bat icons/ AGENTS.md CLAUDE.md GEMINI.md DEV_NOTES.md README.md .gitignore
